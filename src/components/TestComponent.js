...
//               btnWidth={0.3}
//               buttonText={selectedDate ? selectedDate : <></>}
//               btnHeight={0.054}
//               brdradius={50}
//               fontsize={16}
//             />
...
//               btnWidth={0.3}
//               buttonText={startTime ? startTime : <></>}
//               btnHeight={0.054}
//               brdradius={50}
//               fontsize={16}
//             />
...
//             <Text style={{fontSize: 18, fontWeight: 'bold'}}>{daysTime}</Text>
//           </View>
